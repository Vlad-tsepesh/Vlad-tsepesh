package exercises.standart.functional.interfaces.ex1;
...
class Main {
    ...
    public static void printFilteredAccounts(List<Account> accounts) {
        List<Account> nonEmptyAccounts = filter(accounts, a -> a.balance > 0);// write your code here
        List<Account> accountsWithTooMuchMoney = filter(accounts, a -> !a.locked && a.balance >= 100_000_000); // write your code here
